(() => {
    ...
    (() => {
            ...
            priceSlider.forEach((element => {
                if (element) {
                    ...
                    element.noUiSlider.on("update", (function() {
                        ...
                        dec.innerHTML = 1e3 * productCostPerKG * test.querySelector(".noUi-tooltip").innerHTML;
        ...
        document.querySelectorAll(".content-order__line");
        document.querySelectorAll(".content-order__text:not(:last-child)");
        document.addEventListener("click", documentactions);
        function documentactions(e) {
            const target = e.target;
            if (target.closest(".header__city")) document.querySelector(".header__city-questions").classList.add("_active");
            if (!target.closest(".header__city")) document.querySelector(".header__city-questions").classList.remove("_active");
